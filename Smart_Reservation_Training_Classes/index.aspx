...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="Admin" runat="server" visible="false" class="row row-cols-1">
        <div class="col-2 text-center">
            <div class="item-image">
                <a id="linkRoles" runat="server" href="Roles.aspx" onclick="return Loader();">
        ...
        <div class="col-2 text-center">
            <div class="item-image">
                <a id="linkManageReservations" runat="server" href="ManageReservations.aspx" onclick="return Loader();">
        ...
        <div class="col-2 text-center">
            <div class="item-image">
                <a id="linkRooms" runat="server" href="Rooms.aspx" onclick="return Loader();">
        ...
        <div class="col-2 text-center">
            <div class="item-image">
                <a id="linkCourses" runat="server" href="Courses.aspx" onclick="return Loader();">
    ...
    <div id="Users" runat="server" visible="false" class="row row-cols-1">
        <div class="col-2 text-center">
            <div class="item-image">
                <a id="linkNewReservationUser" runat="server" href="NewReservation.aspx" onclick="return Loader();">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">حجز جديد</h5>
                    </div>
                </a>
            </div>
        </div>
        <div class="col-2 text-center">
            <div class="item-image">
                <a id="linkManageMyReservations" runat="server" href="ManageMyReservations.aspx" onclick="return Loader();">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-calendar-check" viewBox="0 0 16 16">
                        <path d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0" />
                        <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z" />
                    </svg>
                    <div class="card-body">
                        <h5 class="card-title">حجوزاتي</h5>
                    </div>
                </a>
            </div>
        </div>
